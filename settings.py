...
DATABASES = {
    'default': {
        'ENGINE': config('DATABASE_ENGINE', 'mysql.connector.django'),
        'NAME': config('DATABASE_NAME', 'linuxjobber_new'),  # linuxjb
        'USER': config('DATABASE_USER', 'linuxjobber'),  # linuxjobber
        'PASSWORD': config('DATABASE_PASSWORD', '8iu7*IU&'),  # linuxjobber
        'HOST': config('DATABASE_HOST', '54.244.162.68'),
...
EMAIL_HOST = config('EMAIL_HOST', 'email-smtp.us-west-2.amazonaws.com')
EMAIL_PORT = config('EMAIL_PORT', '587')
EMAIL_HOST_USER = config('EMAIL_HOST_USER', 'AKIAZRZA7OLFIAUKF55C')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', 'BKboNG78dg2aZHNzuQWb+7aEKPVVDZo4dcw2VufGYC6gL')
EMAIL_USE_TLS = True
...
DEFAULT_FROM_EMAIL = 'test02@chatscrum.com'

GRADER_URL = http://34.222.101.187:31801

# todo Always change to appropriate before pushing
# SERVER details
SERVER_IP = config('SERVER_IP', "34.203.163.3")
...
HOSTING_URL = config('HOSTING_URL', 'HTTP://intworkntutor.linuxjober.com'),

DJOSER = {
    'SEND_ACTIVATION_EMAIL': True,
    'PASSWORD_RESET_CONFIRM_URL': 'auth/reset-password/{uid}/{token}',
    'ACTIVATION_URL': '%s/auth/instructor/confirm-email/{uid}/{token}' % HOSTING_URL,
